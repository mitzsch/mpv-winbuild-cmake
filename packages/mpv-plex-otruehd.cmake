ExternalProject_Add(mpv-plex-otruehd
    DEPENDS
        angle-headers
        ffmpeg-otruehd
        fribidi
...
ExternalProject_Add_Step(mpv-plex-otruehd strip-binary
    DEPENDEES build
    ${mpv_add_debuglink}
    COMMENT "Stripping mpv binaries"
)

ExternalProject_Add_Step(mpv-plex-otruehd copy-binary
...
ExternalProject_Add_Step(mpv-plex-otruehd copy-package-dir
...
force_rebuild_git(mpv-plex-otruehd)
force_meson_configure(mpv-plex-otruehd)
cleanup(mpv-plex-otruehd copy-package-dir)
